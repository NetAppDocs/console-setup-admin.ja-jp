...
* link:reference-iam-predefined-roles.html["データ分類ビューア"]
...
* link:reference-iam-ransomware-roles.html["ランサムウェア耐性管理者"]
* link:reference-iam-ransomware-roles.html["ランサムウェア耐性ビューア"]
* link:reference-iam-ransomware-roles.html#user-behavior-roles["ランサムウェア耐性ユーザー行動管理者"]
* link:reference-iam-ransomware-roles.html#user-behavior-roles["ランサムウェア耐性ユーザー行動ビューア"]
