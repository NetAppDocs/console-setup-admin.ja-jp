...
---
= NetApp Console でパートナーシップユーザーにリソースアクセスを提供する
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
パートナーユーザーには、以下の役割を割り当てることができます：
...
* link:reference-iam-keystone-roles.html["Keystone管理者"]
* link:reference-iam-keystone-roles.html["Keystoneビューア"]
...
. *パートナーシップ*を選択します。
. *パートナーシップ開始*タブを選択します。
. 表示する既存のパートナーシップの横にあるアクションメニューimage:icon-action.png["縦に3つの点があるアイコン"]を選択し、*詳細を表示*を選択します。
+
*メンバー* リストには、パートナー組織がパートナーシップに追加したメンバーが表示されます。

. ロールを割り当てるメンバーの横にあるアクションメニューimage:icon-action.png["縦に3つの点があるアイコン"]を選択し、*ロールを追加*を選択します。
...
.. メンバーの役割の割り当てを解除するには、役割の横にあるimage:icon-delete.png["ゴミ箱に似たアイコン"]を選択して、メンバーから該当する役割を削除します。削除の確認を求められます。
