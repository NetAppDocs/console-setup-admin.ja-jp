...
== コンソールエージェントのネットワークとポートアクセスを確認する
...
Console またはエージェント メンテナンス コンソールから Console エージェントの構成チェックを実行し、必要なエンドポイントにアクセスでき、必要なポートが開いていることを確認します。

エージェント メンテナンス コンソールを使用して構成チェックを実行することもできます。link:reference-agent-maint-console-config-checker.html["config-checker validate コマンドの使用について詳しく学習します。"]
