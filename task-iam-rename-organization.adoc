...
---
= NetApp Console の組織名を変更してIDを取得する
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: 
...
[role="lead"]
NetApp Console組織には名前とIDがあります。組織を識別しやすくするために、組織の名前を選択できます。API呼び出しに使用する組織IDを知っておく必要がある場合もあります。
...
組織名を変更できます。複数の組織をサポートしている場合に役立ちます。
...
+
image:screenshot-iam-edit-organization.png["アクションアイコンと「組織の編集」オプションが表示された組織ページのスクリーンショット。"]
