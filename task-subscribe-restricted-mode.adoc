...
summary: クラウド プロバイダーのマーケットプレイスからNetApp Intelligent Servicesにサブスクライブして、 NetAppデータ サービスの料金を時間単位または年間契約で支払います。 NetAppからライセンスを購入した場合は、マーケットプレイス オファリングにもサブスクライブする必要があります。最初にライセンスに対して課金が行われますが、ライセンス容量を超えた場合、またはライセンスの有効期限が切れた場合は、時間単位で課金されます。 
---
