...
NOTE: 組織管理者ロールを持つユーザーは、リソースをフォルダーに追加することで、そのリソースをプロジェクトに関連付けるタスクを、それぞれのフォルダーのフォルダー管理者またはプロジェクト管理者に委任できます。link:task-iam-manage-folders-projects.html#associate-resource-folder["リソースをフォルダに関連付ける方法について学習します"]。
