...
| *config.deployments.get* | いいえ | はい | いいえ 
...
| *コンピューティングヘルスチェックの作成* .4+| バックエンド サービスの健全性を監視するためにヘルス チェックを作成および管理します。 | いいえ | はい | いいえ 
...
| *logging.logEntries.create* .2+| 監視、デバッグ、監査のためにログエントリを作成してルーティングします。 | はい | はい | いいえ 


| *logging.logEntries.route* | はい | はい | いいえ 
...
| *compute.regionBackendServices.update* | はい | はい | いいえ 
