...
たとえば、Microsoft Entra IDを使用している場合は、Microsoftのドキュメントlink:https://learn.microsoft.com/en-us/entra/fundamentals/add-custom-domain["Microsoft Entra ID でドメインを追加する"]の手順に従ってください。
