...
---
= AWS Marketplace から NetApp Console エージェントをデプロイする
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.手順
.  https://aws.amazon.com/marketplace/pp/prodview-jbay5iyfmu6ui["AWS Marketplace でのNetApp Consoleエージェントのリスト"^]に移動します。
