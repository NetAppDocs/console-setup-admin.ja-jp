...
summary: コンソールエージェントをオンプレミスにデプロイし、ログインしてコンソール組織と連携するように設定します。 
---
= オンプレミスに NetApp Console エージェントを手動でインストールする
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NOTE: VMware ユーザーであれば、OVA を使用して vCenter に Console エージェントをデプロイできます。link:task-install-agent-on-prem-ova.html["vCenter でのエージェントの導入の詳細については、こちらをご覧ください。"]
