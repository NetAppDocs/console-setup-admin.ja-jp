...
summary: NetAppコンソールで組織間のパートナーシップを構築すると、組織のパートナーは組織の境界を越えてNetAppリソースを安全に管理できるようになり、コラボレーションが効率化され、セキュリティが強化されます。 
---
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-3.png["三つ"]NetAppコンソール内でパートナーシップを開始する
[role="quick-margin-para"]
