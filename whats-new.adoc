...
| バックアップとリカバリ | 5.0.3（2026年3月2日） |  https://docs.netapp.com/us-en/data-services-backup-recovery/whats-new.html["NetApp Backup and Recoveryの新機能ページ"^]に移動します。 


| 分類 | 1.5.1（2026年2月9日） |  https://docs.netapp.com/us-en/data-services-data-classification/whats-new.html["NetApp Classification の新機能ページ"^]に移動します。 
|===
